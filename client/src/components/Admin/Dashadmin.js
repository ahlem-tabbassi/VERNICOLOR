...
const Dashadmin = () => {
  ...
  useEffect(() => {
    // Initialize reportRef here
    reportRef.current = document.querySelector("#reportContainer iframe");
    fetchSuppliers();
  }, []);
  ...
  const handleRefresh = () => {
    ...
    if (reportRef.current) {
      const report = powerbi.get(reportRef.current);
      report.refresh();
      console.log("Report refreshed successfully.");
    } else {
      console.log("Report reference is null.");
    }
  };
    ...
    <div>
      <center>
        ...
        >
          <Row className="mt-9">
            <Col md={12}>
              <section id="reportContainer" style={{ width: "80%", height: "100px" }}>
                <iframe
                  title="pfedashboard"
                  width="110%"
                  height="630px"
                  src="https://app.powerbi.com/reportEmbed?reportId=37eea7d4-8c42-4ef6-93ff-7d3502885c29&autoAuth=true&ctid=84c31ca0-ac3b-4eae-ad11-519d80233e6f&navContentPaneEnabled=false&filterPaneEnabled=false&$filter=Query2/Name eq 'Type2'"
                  frameborder="0"
